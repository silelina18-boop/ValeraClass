...
//         Создано Vue приложение с использованием Composition API

//         Данные календаря хранятся в реактивном массиве calendars

//     Метод создания календаря:

//         createCalendar метод генерирует структуру данных для каждого месяца

//         Возвращает объект с информацией о месяце и массиве недель с днями

//     Шаблон Vue:

//         Используется директивы v-for для отрисовки месяцев, недель и дней

//         Условное применение класса weekend через :class

//     Инициализация:

//         В хуке mounted создаются календари для учебного года

// Этот код полностью функционален и может быть запущен в браузере с подключенной библиотекой Vue.js.